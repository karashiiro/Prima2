...
public class CheckCastrumEventsJob : CheckEventChannelJob
{
    public CheckCastrumEventsJob(IAppLogger logger, DiscordSocketClient client, IDbService db) : base(logger, client, db)
    {
    }
