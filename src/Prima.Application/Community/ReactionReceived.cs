...
public static class ReactionReceived
{
    ...
    public static async Task HandlerAdd(DiscordSocketClient client, IDbService db, CharacterLookup lodestone, Cacheable<IUserMessage, ulong> message, Cacheable<IMessageChannel, ulong> cchannel, SocketReaction reaction)
    {
    ...
    public static async Task HandlerRemove(IDbService db, Cacheable<IUserMessage, ulong> message, Cacheable<IMessageChannel, ulong> cchannel, SocketReaction reaction)
    {
        var ichannel = await cchannel.GetOrDownloadAsync();
